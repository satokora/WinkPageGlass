...
public class HeadGestureDetector {
    ...
    private static final long MAX_DURATION = TimeUnit.MILLISECONDS.toNanos(1200);
    private static final float MIN_GRVITY_LEAN_DEGREE = 1.0F;
    private static final float MIN_GRAVITY_STABLE_DEGREE = 1.0F;
    ...
    //private static final int[] REQUIRED_SENSORS = { Sensor.TYPE_GYROSCOPE, Sensor.TYPE_GRAVITY };
